...
<body>
    ...
    <div id="formu">
        <h1 id="titulo_principal" class="text-center">Registrar Vacunas</h1>
        ...
        <div class="col-sm-4 offset-sm-4">
            ...
            <form action="guardar_vacuna.php" method="post">
                ...
                <div class="mb-3">
                    <th><b><label for="">Nombre de Vacuna:</label></b></th>
                    <th><input class="form-control" type="text" name="nombre_v" id=""></th>
                </div>
