...
<div id="list" class="col-sm-6 offset-sm-3">
    <h1 class="text-center  mt-5">Listado de Cocineros</h1>
    ...
    <table class="table ">
        ...
        <tbody>
            ...
            while ($persona = mysqli_fetch_assoc($resultado)) {
                ...
                echo "<td><b>" . $persona['nombre_v'] . "</b></td>";
                echo "<td>";
                echo "<a href='/hospital/editar_vacuna.php?id_vacuna=" . $persona['id_vacuna'] . "' class='btn btn-success mx-2 my-2'> <i class='fas fa-pen'></i> </a>";
                echo "<a href='/hospital/eliminar_vacuna.php?id_vacuna=" . $persona['id_vacuna'] . "' class='btn btn-danger mx-2 my-2'> <i class='fas fa-trash'></i> </a>";
                echo "</td>";
                echo "</tr>";
            }
            ?>
